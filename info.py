...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004457217205'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003948498853")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
